...
# DIRS is a list of filesystem directories to check when loading Django templates; it’s a search path. #Chapter 7
...
SECRET_KEY = 'django-insecure-gw+hx_#p9fwv#2&jp)@olu(7%bh2+c#$_h(w2-x!&ak8ma*$v9'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    'mico28.pythonanywhere.com',
    'localhost',
    '127.0.0.1'
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'], # Chapter 7 of tutorial customizing template
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
